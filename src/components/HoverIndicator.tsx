      ...
      if (isVertical) {
        ...
        if (firstButton && lastButton) {
          ...
          if (mouseX < firstButtonCenter - hoverDisplayMargin) {
            ...
            console.log(
              "DEBUG - Left boundary triggered, setting left to:",
              left,
            );
            ...
            console.log(
              "DEBUG - Right boundary triggered, setting left to:",
              left,
            );
          } else {
      ...
      if (isVertical) {
        ...
        if (firstButton && lastButton) {
          ...
          if (mouseX < firstButtonCenter - hoverDisplayMargin) {
            ...
            console.log(
              "DEBUG - Left boundary triggered in update, setting calculatedLeft to:",
              calculatedLeft,
            );
          } else if (mouseX > lastButtonCenter + hoverDisplayMargin) {
            ...
            console.log(
              "DEBUG - Right boundary triggered in update, setting calculatedLeft to:",
              calculatedLeft,
            );
          } else {
            console.log(
              "DEBUG - Normal tracking in update, calculatedLeft:",
              calculatedLeft,
            );
          }
        }
